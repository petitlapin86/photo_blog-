...
import {EntryListComponent, EntryComponent, EntryService, EntryCommentFormComponent} from './entries'; //using a barrel so everything is accessible from this one import
